# app/vector_store.py
# --------------------
# ChromaDB-backed vector store: builds/saves/loads the collection under 
# vector_db/, and performs top-k similarity search.
...
from app.config import COLLECTION_NAME, VECTOR_DB_DIR
