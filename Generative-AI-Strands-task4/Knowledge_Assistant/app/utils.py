# app/utils.py
# ------------
# Small, dependency-light helpers used by ingestion: reading text out of
# PDFs/.md/.txt files, chunking, and section-heading detection. Kept
# separate from ingestion.py so they're easy to unit test on their own.
